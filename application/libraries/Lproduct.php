...
class Lproduct {
    ...
    public function product_history()
    {
        ...
        $productList = $CI->parser->parse('product/product_history',$data,true);
        return $productList;
    }
    ...
    public function product_edit_data($product_id) {
        ...
        $category_selected = $CI->Categories->category_search_item($category_id);
            ...
            $data['merek']        = $product_detail[0]['merek'];
            $data['dimension']        = $product_detail[0]['dimension'];
            $data['bobot']        = $product_detail[0]['bobot'];
            $data['stokmin']        = $product_detail[0]['stokmin'];
            $data['stock_start']        = $product_detail[0]['stock_start'];
            $data['stokmax']        = $product_detail[0]['max_stock'];
            $data['leadtime']        = $product_detail[0]['lead_time'];
