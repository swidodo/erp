...
// supplier return list
    ...
    public function invoice_html_data($invoice_id) {
        ...
        $data = array(
            'title'            => display('invoice_return'),
            'number'       => $invoice_detail[0]['number'],
            'invoice_id'       => $invoice_detail[0]['invoice_id'],
            ...
            'total_amount'     => number_format($invoice_detail[0]['net_total_amount'], 0, '.', ','),
            'subTotal_quantity'=> $subTotal_quantity,
            'deduction'        => number_format($invoice_detail[0]['deduction'], 0 ,'.', ','),
            'total_deduct'     => number_format($invoice_detail[0]['total_deduct'], 0, '.', ','),
            'total_tax'        => number_format($invoice_detail[0]['total_tax'], 0, '.', ','),
            'subTotal_ammount' => number_format($subTotal_ammount, 0, '.', ','),
            'totalnamount'     => number_format(($subTotal_ammount+$invoice_detail[0]['total_tax'])-$invoice_detail[0]['total_deduct'], 0, '.', ','),
    ...
    public function supplier_html_data($purchase_id) {
        ...
        $data = array(
            ...
            'number'        => $return_detail[0]['number'],
            'address'        => $return_detail[0]['address'],
            'mobile'         => $return_detail[0]['mobile'],
            'final_date'     => $return_detail[0]['final_date'],
            'total_amount'   => number_format($return_detail[0]['net_total_amount'], 0, '.', ','),
            'subTotal_quantity' => $subTotal_quantity,
            'deduction'      => number_format($return_detail[0]['deduction'], 0, '.', ','),
            'total_deduct'   => number_format($return_detail[0]['total_deduct'], 0, '.', ','),
            'subTotal_ammount' => number_format($subTotal_ammount, 0, '.', ','),
