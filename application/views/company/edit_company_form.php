            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label"><?php echo 'Company Code' ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control" name="company_code">
                                <option value="{company_code}" selected>{company_code}</option>
                        ...
                        <div class="form-group row">
                            <label for="npwp" class="col-sm-3 col-form-label"><?php echo 'NPWP' ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="3" class="form-control" value="{npwp}" name="npwp" placeholder="<?php echo 'NPWP' ?>" required tabindex="5"/>
                            </div>
                        </div>
