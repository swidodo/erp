            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4 class="charttitle"> Rekapitulasi Stok Habis</h4>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if ($total_stokmin) {
                                            $sl = 0;
                                            foreach ($total_stokmin as $stmin) {
                                            $totalstok = ($stmin->stock_start + $stmin->totalPurchaseQnty) - $stmin->totalSalesQnty;

                                            if($totalstok <= $stmin->stokmin):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $stmin->category_name;?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo $stmin->stokmin.' '.$stmin->unit;;?>
                                                    </td>
                                                   
                                                    <td class="text-right">
                                                        <?php echo $totalstok.' '.$stmin->unit;?>
                                                    </td>
