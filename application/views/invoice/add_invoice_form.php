            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">Pelanggan <i class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="pono" class=" form-control" placeholder='Masukkan No. PO' id="pono" tabindex="1"/>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-3 col-form-label">PO Date</label>
                                    <div class="col-sm-6">
                                        <input type="date" name="tglpo" class=" form-control" placeholder='Masukkan No. PO' id="tglpo" tabindex="1"/>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                       <select name="bank_id" class="form-control bankpayment"  id="bank_id">
                                            ...
                                            <?php foreach($bank_list as $bank){?>
                                                <option value="<?php echo html_escape($bank['bank_id'])?>"><?php echo html_escape($bank['bank_name']);?> - <?php echo html_escape($bank['ac_name']);?> - <?php echo html_escape($bank['branch']);?></option>
                                            <?php }?>
                                        </select>
                ...
                <i class="fa fa-angle-double-down"></i>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"  class="text-right"><b><?php echo display('change'); ?>:</b></td>
                                    <td class="text-right">
