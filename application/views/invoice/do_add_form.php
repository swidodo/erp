        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cinvoice/do_insert', array('class' => 'form-vertical', 'id' => 'invoice_update')) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" id="payment_from_1">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="po_id" class=" form-control" placeholder='Masukkan No. PO' id="pono" tabindex="1"readonly="readonly" value="{po_no}"/>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="payment_from">
                                <div class="form-group row">
                                    ...
                                    <input type="date" name="tgldo" class=" form-control" placeholder='Masukkan No. PO' id="tgldo" tabindex="1" value="{date}" readonly/>
                        ...
                        <div class="row">
                         ...
                         <div class="form-group row">                            
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="type" class="form-control" data-placeholder="<?php echo display('select_one'); ?>" readonly >
                                        <option value="To be invoice later">To be invoice later</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="product_quantity[]" onclick="quantity_calculate({sl});" onchange="quantity_calculate({sl});" value="{qtyd}" class="total_qntt_{sl} form-control text-right" id="total_qntt_{sl}" min="0" tabindex="4" required="required"/>

                                            <input type="hidden" name="qty_jual_{sl}" value="{quantity}" id="qty_jual_{sl}">
                                        <!-- </td>

                                        <td> -->
                                            <input type="hidden" name="desc[]" value="" id="desc_{sl}" class="desc{sl} form-control" placeholder="Masukkan Deskripsi"/>
                                        </td>
                               ...
                               <!--  <tfoot>
                                    <tr>
                                        <td colspan="6">
                                            <b>DO Details :</b> -->
                                            <textarea type="hidden" id="ket" name="keterangan" class="form-control" rows="4" placeholder="Masukkan Keterangan"></textarea>
                                       <!--  </td>
                                    </tr>
                                </tfoot> -->
                            ...
                            <?=anchor('cinvoice/manage_invoice','Batalkan',['class'=>'btn btn-danger']);?>
