...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Buat Invoice Penawaran</h1>
            <small>Buat Invoice Baru</small>
            <ol class="breadcrumb">
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="invoiceNo" id="invoiceno" class="form-control" placeholder="<?php echo display('invoice') ?>" value="<?php echo $noInv[0]['InvNo']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tr>
                                    <td colspan="6"  class="text-right"><b><?php echo 'Sub Total'; ?>:</b></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                       <input type="text" id="grandTotal" class="form-control text-right" value="<?php echo $quot_main[0]['item_total_amount']+$quot_main[0]['item_total_tax']; ?>" readonly="readonly" />
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                         ...
                         <div class="row" id="quotation_service" >
                           ...
                           <div class="table-responsive margin-top10">
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tr>
                                    <td colspan="4"  class="text-right"><b><?php echo display('total_tax') ?>:</b></td>
                                    <td class="text-right">
                                        <?php $x=0;
                                        foreach($taxes as $taxfldt){
                                            $stxssinf= 'tax'.$x;
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="serviceGrandTotal" class="form-control text-right" value="<?php echo $quot_main[0]['service_total_amount']+$quot_main[0]['service_total_tax']; ?>" readonly="readonly" />
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                            ...
                            <table class="table" style="text-align:right;">
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <?php 
                                        $net = number_format(($quot_main[0]['item_total_amount']+$quot_main[0]['item_total_tax'])+($quot_main[0]['service_total_amount']+$quot_main[0]['service_total_tax']));
                                        echo $net;
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>TOTAL INVOICE</td>
                                    <td colspan="2"><?php echo number_format($quot_main[0]['Tot'][0]['total_amount']);?></td>
                                </tr>
                                <tr>
                                    <td>DUE</td>
                                    <td colspan="2"><?php echo number_format((($quot_main[0]['item_total_amount']+$quot_main[0]['item_total_tax'])+($quot_main[0]['service_total_amount']+$quot_main[0]['service_total_tax']))-($quot_main[0]['Tot'][0]['total_amount']));?></td>
                                </tr>
                                <tr>
                                    <td>
                                        TOP
                                    ...
                                    <td>
                                        <select name="type_top" id="type_top" class="form-select form-control" width="20">
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-right" name="persent" placeholder="Prosetase DP %">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right" style="vertical-align:middle;"><strong>VALUE INVOICE</strong></td>
                                    <td colspan="2" width="30%">
                                        <input type="text" class="form-control text-right" name="grand_total_price" value="<?php echo (($quot_main[0]['item_total_amount']+$quot_main[0]['item_total_tax'])+($quot_main[0]['service_total_amount']+$quot_main[0]['service_total_tax']))-($quot_main[0]['Tot'][0]['total_amount']); ?>" required/>
                                    </td>
                                    <!-- <?php if ($isinv ==null):?>
