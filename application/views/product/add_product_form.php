                    ...
                    <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control" name="product_id" type="text" id="product_id" placeholder="<?php echo display('product_id') ?>" required tabindex="1" >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="serial_no" class="col-sm-4 col-form-label">Size<?php //echo display('serial_no') ?> </label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control " id="size" name="size" placeholder="111,abc,XYz"   />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="merek" name="merek" placeholder="<?php echo display('brand') ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="dimensi" type="text" id="dimensi" placeholder="<?php //echo display('product_name') ?>" tabindex="1" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control " id="bobot" name="bobot" placeholder=""   />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockstart" type="text" id="stockstart" placeholder="Masukkan Stok Awal" required min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockmin" type="text" id="stockmin" placeholder="Masukkan Stok Minimum" required min="0">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockmax" type="text" id="stockmax" placeholder="Masukkan Stok Maksimum" required min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Laed Time <?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="leadtime" type="text" id="leadtime" placeholder="Masukkan Lead Time" required min="0">
