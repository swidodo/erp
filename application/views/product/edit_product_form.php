                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <label for="product_id" class="col-sm-2 col-form-label"><?php echo display('product_id') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-5">
                                        <input class="form-control" name="product_id" type="text" id="product_id" placeholder="<?php echo display('product_id') ?>" required tabindex="1" value
                                        ="{product_id}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="serial_no" class="col-sm-4 col-form-label"><?php echo display('size') ?> </label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="size" name="size" placeholder="<?php echo display('size') ?>"  value='{size}'/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_model" class="col-sm-4 col-form-label"><?php echo display('brand') ?> <i class="text-danger"></i></label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" name="merek" placeholder="<?php echo display('brand') ?>"   value="{merek}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Dimension<?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="dimensi" type="text" id="dimensi" placeholder="<?php echo display('dimension') ?>" tabindex="1" value='{dimension}'>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="serial_no" class="col-sm-4 col-form-label"><?php echo 'Bobot'; ?> </label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control " id="bobot" name="bobot" placeholder="" value="{bobot}" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Stok Awal <?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockstart" type="text" id="stockstart" placeholder="Masukkan Stok Awal" required min="0" value="{stock_start}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Stok Minimal <?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockmin" type="text" id="stockmin" placeholder="Masukkan Stok Minimum" required min="0" value="{stokmin}">
                                        <small class="text-danger">Stok Minimal akan menjadi notifikasi limit stok.</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Stok Maks. <?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="stockmax" type="text" id="stockmax" placeholder="Masukkan Stok Maksimum" required min="0" value="{stokmax}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label">Lead Time <?php //echo display('product_name') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="leadtime" type="text" id="leadtime" placeholder="Masukkan Lead Time" required min="0" value="{leadtime}">
                                    </div>
                                </div>
                            </div>
                       ...
                       <?php $i++;}?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="3" placeholder="<?php echo display('product_details') ?>" tabindex="2">{product_id}, {product_name}, {product_details}, {merek}, {size}, {dimension}, {bobot}</textarea>
                            </div>
                        </div><br>
                        <div class="form-group row">
                            <div class="col-sm-6">
