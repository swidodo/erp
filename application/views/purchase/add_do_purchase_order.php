        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cpurchase/do_insert_po', array('class' => 'form-vertical', 'id' => 'do_purchase')) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="purchase_id">
                                <div class="form-group row">
                                    <label for="purchase_id" class="col-sm-3 col-form-label">PO ID </label>
                                    <div class="col-sm-6">
                                        <input type="text" class=" form-control"  id="purchase_id" tabindex="1" value='<?= $purchase[0]['purchase_order'];?>' readonly/> 
                                        <input type="hidden" name="po_id" value='<?= $purchase[0]['po_id'];?>' readonly/>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="podate">
                                <div class="form-group row">
                                    <label for="purchasedate" class="col-sm-3 col-form-label">PO Date</label>
                                    <div class="col-sm-6">
                                        <input type="date" name="purchase_date" class=" form-control" id="podate" tabindex="1" value="<?= $purchase[0]['po_date'];?>"  readonly/>
                                    </div>
                            ...
                            <div class="col-sm-6" id="paydate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="invoice_no" class=" form-control" id="invoice" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6" id="date">
                                <div class="form-group row">
                                    <label for="bpb" class="col-sm-3 col-form-label">Received Goods Date</label>
                                    <div class="col-sm-6">
                                        <input type="date" name="date" class=" form-control" id="bpb" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6" id="paydate">
                                <div class="form-group row">
                                    <label for="purchasedate" class="col-sm-3 col-form-label">Invoice Date</label>
                                    <div class="col-sm-6">
                                        <input type="date" name="invoice_date" class=" form-control" id="invoicedate" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="paydate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" name="due_date" class=" form-control" id="due" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-sm-6" id="dodate">
                             ...
                             <div class="col-sm-6" id="dodate">
                                <div class="form-group row">
                                    <label for="pajak" class="col-sm-3 col-form-label">Tax Date
                                        </label>
                                    <div class="col-sm-6">
                                    <input type="date" name="tax_date" class=" form-control" id="pajak" tabindex="1" />
                                    </div>
                                </div>
                            </div>
                        </div>                     
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="dodate">
                                <div class="form-group row">
                                    <label for="dodate" class="col-sm-3 col-form-label">Payment
                                        </label>
                                    <div class="col-sm-6">
                                    <input type="text" name="payment" class=" form-control"  id="payment" tabindex="1" />
                                    </div>
                                </div>
                            </div>
                             <div class="col-sm-6" id="paydate">
                        ...
                        <!-- <div class="table-responsive">
                            ...
                            <div class="well well-sm">
                                <a href="<?= base_url('Cpurchase/po_detail/'.$purchase[0]['po_id']);?>" class="btn btn-sm btn-warning">Cancel</a>
