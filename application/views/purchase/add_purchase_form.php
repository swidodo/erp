                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cpurchase/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                               <div class="form-group row">
                                    <label for="details" class="col-sm-2 col-form-label"><?php echo display('details') ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" tabindex="4" id="details" name="purchase_details" placeholder=" <?php echo display('details') ?>" rows="1"></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
...
<!-- Purchase Report End -->
<script>
    $('#ppnpurchase').on('change',function(){
        var ppn = $('#ppnpurchase').val();
        
        if (ppn=='Y')
        {
            $('#valueppn').html('<option value="11">11 %</option>');
        }
        if (ppn=='N'){
            $('#valueppn').html('<option value="0">0 %</option>');
        }
    })
</script>
