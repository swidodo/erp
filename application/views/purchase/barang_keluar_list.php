...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1>Surat Bukti Keluar Barang</h1>
	        <small>Kelola data surat bukti keluar barang</small>
	        <ol class="breadcrumb">
	            <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('purchase') ?></a></li>
	            <li class="active">Kelola Surat Keluar Barang</li>
	        </ol>
	    </div>
	</section>
		        ...
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="BarangkeluarList"> 
								<thead>
									<tr>
