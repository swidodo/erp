...
<head>
    ...
    if($target == null){
      echo site_url('Cpurchase/manage_barang_masuk');
    } else {
      echo site_url('cpurchase/manage_barang_masuk');
    }?>" /> -->
...
<body>
  <header>
  <!-- <div class="title"> -->
      <div style="text-align: right;margin-top: -70px"> F-CIKA-006-00</div>
      <img src="<?php
    ...
    <center>
      <h3 style="font-size: 12pt; margin-top: -20px">SURAT BUKTI BARANG MASUK</h3>
    </center> 

    <div class="content" style="text-align:left;margin-top: 10px;"> 
      <table border="0" width="100%" cellpadding="1" style="margin-bottom:20px;">
      	<tr valign="top">
          <td valign="top" width="10%">Vendor</td>
          <td valign="top" width="1%">:</td>
          <td valign="top" width="45%"><?php echo $query[0]['supplier_name'];?></td>
        ...
        <tr valign="top">
          ...
          <td valign="top">:</td>
          <td valign="top"><?php echo date('F d, Y',strtotime($query[0]['bm_date']));?></td>
        </tr>
      ...
      <table border="0" width="100%" class="table table-bordered mt-5" cellpadding="3">
      <thead>	
      <tr bgcolor="#eeeeee">
      ...
      <table border="0" width="100%">
          <tr>
              <td width="40%">
              Logistic Admin,<br>
              <br><br><br><br><b>Mila</b> 

              </td>

              <td width="30%">
              Logistic Manager,<br>
              <br><br><br><br><b>Hidayat</b>
