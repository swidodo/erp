                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cpurchase/purchase_update',array('class' => 'form-vertical', 'id' => 'purchase_update'))?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 ">
                                        <input type="date" class="form-control" name="duedate" id="duedate" required  value="{duedate}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                                <label for="payment_type" class="col-sm-4 col-form-label">PPN</label>
                                        </div>
                                        <div class="col-sm-8" id="vppn">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <?php //print_r($ppn); ?>
                                                    <select id="ppnpurchase" class="form-control" required>
                                                        <?php if ($ppn =="11"){
                                                            $selected = "selected";
                                                            $noselected = "";
                                                        }else{
                                                        ...
                                                        <option value="Y" <?php echo $selected;?>>Yes</option>
                                                        <option value="N" <?php echo $noselected;?>>No</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                        <select name="ppn" id="valueppn" class="form-control" required>
                                                        <option value="0" <?php echo $noselected;?>>0 %</option>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <label for="adress" class="col-sm-2 col-form-label"><?php echo display('details') ?>
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                     <tr>
                                            ...
                                            <th class="text-center"><?php echo 'Ppn'; ?></th>
                                ...
                                <tbody id="addPurchaseItem">
                                    ...
                                    <tr>
                                       ...
                                       <td class="wt">
                                            <!-- <input type="text" id="available_quantity_{sl}" class="form-control text-right stock_ctn_{sl}" value="<?= $avaluable;?>" placeholder="0.00" readonly/> -->
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" colspan="3"><b><?php echo display('due_amount') ?>:</b></td>
                                        <td class="text-right">
