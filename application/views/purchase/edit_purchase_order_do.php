                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6" id="purchase_id">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class=" form-control"  id="purchase_id" tabindex="1" value='<?= $do[0]['purchase_order'];?>' readonly/> 
                                        <input type="hidden" name="po_id" value='<?= $do[0]['po_id'];?>' readonly/>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="podate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" name="purchase_date" class=" form-control" id="podate" tabindex="1" value="<?= $do[0]['po_date'];?>"  readonly/>
                                    </div>
                            ...
                            <div class="col-sm-6" id="paydate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="invoice_no" value="<?= $do[0]['invoice_no'];?>" class=" form-control" id="invoice" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                              <div class="col-sm-6" id="date">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" name="date" class=" form-control" value="<?= date('Y-m-d',strtotime($do[0]['date']));?>" id="purchasedate" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6" id="paydate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" name="invoice_date" class=" form-control" value="<?= $do[0]['invoice_date'];?>" id="invoivedate" tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="dodate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="date" name="tax_date" value="<?= $do[0]['tax_date'];?>" class=" form-control" id="pajak" tabindex="1" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6" id="dodate">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" name="payment" class=" form-control" value="<?= $do[0]['payment'];?>" id="payment" tabindex="1" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6" id="paydate">
                        ...
                        <!-- <div class="table-responsive">
                            ...
                            <div class="well well-sm">
                                <a href="<?= base_url('Cpurchase/po_detail/'.$do[0]['po_id']);?>" class="btn btn-sm btn-warning">Cancel</a>
