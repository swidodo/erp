...
<body>
  <!-- <div class="title pagedjs_margin-top pagedjs_margin-content"> -->
    <header>
    <div style="text-align: right;padding-top: 10px;margin-top:-80px;"> F-<?=$query[0]['perusahaan'] ?>-005-00</div>
    <?php if ($query[0]['perusahaan'] == "CIKA") :?>  
      <img src="<?php  echo $Web_settings[0]['invoice_logo'];?>" class="h-50 w-50" alt="logo" style="margin-top:-20px;" > 
    <?php elseif ($query[0]['perusahaan'] == "KIA") :?> 
       <img src="<?php  echo $Web_settings[0]['invoice_logo_2'];?>" class="h-50 w-50" alt="logo"> 
    <?php else :?>
       <img src="<?= base_url();?>my-assets/image/logo/st.png" class="h-50" alt="logo"> 
    <?php endif;?>
    <hr style="margin-top: -14px;border-weight:10px;border-color:blue;">
    </header>
    <footer>
    <div class="pagenum-container">Page <span class="pagenum"></span></div>
  </footer>
    <p style="margin-top: -20px;font-size: 12pt;text-align:center">PURCHASE ORDER</p>
  <!-- </div> -->
  <table width="100%" class="table table-sm" cellpadding="1" style="margin-top: 10px;">
      <tbody>
        <tr>
          ...
          <table width="100%" style="border-top:0px; border-left: 0px !important;border-bottom:0px !important;">
            ...
            <tr valign="top">
              ...
              <td valign="top">:</td>
              <td valign="top"><?php echo $query[0]['supplier_name'];?></td>
              <td valign="top">No. PO</td>
              <td valign="top">:</td>
              <td valign="top">
                <?php 
                echo $query[0]['purchase_order']; 
                if($query[0]['count_update'] >='1'){echo ".R".$query[0]['count_update'];}else{echo'';}?>/<?= $query[0]['perusahaan'];?>-PO/<?=romawi(intval(date('m',strtotime($query[0]['po_date'])))).'/'.date('Y',strtotime($query[0]['po_date']));?>
              </td>
            </tr>
            <tr valign="top">
              <td>Phone</td>
    ...
    <!-- <tr> -->
      <td colspan="8" style="border-top:0px; border-left: 0px;">
          Please deliver the following goods listed below :
      </td>
    <!-- </tr>
    </tr> -->
    </table>
        ...
        <tr bgcolor="#eeeeee">
      	...
      	if(!empty($query)){
              ...
              <td style="border:1px solid #000;border-bottom: 1px solid #cccccc; padding-left:4px;" width="25%"><?php echo $row['product_name'].' '.$row['size']. ' ('.$row['merek'].')';?></td>
              <td style="text-align:center;border:1px solid #000;border-bottom: 1px solid #cccccc;" width="10%"><?= $row['product_id'];?></td>
              <td style="text-align:center;border:1px solid #000;border-bottom: 1px solid #cccccc;" width="10%"><?php echo $row['qty'];?></td>
              ...
              <td style="text-align:center;border:1px solid #000;border-bottom: 1px solid #cccccc;" width="5%"><?php echo $row['discount'];?></td>
              <td style="text-align:right;border:1px solid #000;border-bottom: 1px solid #cccccc;" width="15%"><?php echo number_format($row['total_price'],0,",",".");?></td>
              <td style="text-align:right;border:1px solid #000;border-bottom: 1px solid #cccccc;" width="15%"><?= $row['remark'];?></td>
            </tr>
      			<?php
                  $totalharga += $row['ttl_price'];
      		endforeach;
      	}
          ?>
          <!-- </tbody> -->
          ...
          <tr>
              ...
              <th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:2px solid #000;border-bottom:1px solid #000;" width="15%"><?= number_format($query[0]['total_amount']);?></th><th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:2px solid #000;border-bottom:1px solid #000;">&nbsp;</th>
          </tr>
          <tr>
              <th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;" colspan="7">Tax <?= $query[0]['tax'];?>%</th>
              <th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;" width="15%"><?= number_format($query[0]['value_tax']);?></th><th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;">&nbsp;</th>
          </tr>
          <tr>
              ...
              <th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;" width="15%"><?= number_format($query[0]['total_amount'] + $query[0]['value_tax']);?></th><th style="text-align:right;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;">&nbsp;</th>
          </tr>
      </table>
          <!-- </tr>
            ...
            <td colspan="9"> -->
              <table width="100%">
                <tr valign="top">
                  ...
                  <td widht="35%" style="padding-bottom: 15px;"><b><?=$query[0]['note'];?></b></td>
                </tr>
                <tr valign="top">
                ...
                <tr valign="top">
                  ...
                  <td width="10%" rowspan="2">Delivery Address</td>
                  <td width="1%" rowspan="2">:</td>
                  <td widht="35%" rowspan="2"><?=$query[0]['note_delivery_address'];?></td>
                </tr>
            <tr>
            <tr valign="top">
              ...
              <table border="0" width="100%" style="margin-top:20px;">
                <tr>
                    <td width="20%" valign="top">
                      Received by,<br>
                      <br><br><br><br><br><b><?= $query[0]['ttd_1'];?></b> 
                    </td>
                    <td width="20%" valign="top">
                      User,<br>
