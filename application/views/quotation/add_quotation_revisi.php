        ...
        <div class="row">
            <div class="col-sm-12">                
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cquotation/revisi_quotation', array('class' => 'form-vertical', 'id' => 'insert_quotation')) ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="type" class="form-control" data-placeholder="<?php echo display('select_one'); ?>">
                                        ...
                                        <?php elseif ($quot_main[0]['type']=="Include"):?>
                                            <option value="<?= $quot_main[0]['type'];?>" selected style="background:#eeeeee;"><?= $quot_main[0]['type'];?></option>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <?php
                                        ...
                                        foreach ($quot_product as $item) {
                                            ...
                                            $av = $this->db->query("SELECT a.stock_start + (SELECT if (quantity !='',SUM(quantity),0) as qtyp FROM product_purchase_details WHERE product_id='$product_id') - (SELECT if (quantity !='',SUM(quantity),0) as qtyinv FROM invoice_details WHERE product_id='$product_id' and status='2') as avalable 
                                                                    FROM product_information as a WHERE a.product_id='$product_id'");
                                ...
                                <tfoot>
                                    ...
                                    <!-- <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right" name="grand_total_price" value="<?php echo number_format($quot_main[0]['item_total_amount']+$quot_main[0]['item_total_tax'],2); ?>" readonly="readonly" />
                                        </td>
                                    </tr> -->
                                </tfoot>
                            </table>
                        ...
                        <table class="table table-bordered table-hover" id="serviceInvoice">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="serviceGrandTotal" class="form-control text-right" value="<?php echo $quot_main[0]['service_total_amount']; ?>" readonly="readonly" />
                                    </td>
                                </tr> -->
                            </tfoot>
                        </table>
            ...
            <div class="form-group row">
                <label for="example-text-input" class="col-sm-4 col-form-label"></label>
                    <div class="col-sm-6">
                        <a href="<?= base_url('Cquotation/manage_quotation');?>" class="btn btn-warning btn-large">Back</a>
                        <input type="submit" id="add-quotation" class="btn btn-success btn-large" name="add-quotation" value="<?php echo 'Revisi'; ?>" />
                    </div>
                        </div>
                    </div>               
                    <?php echo form_close() ?>
