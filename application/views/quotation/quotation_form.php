            ...
            <div class="col-sm-12">                
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="perusahaan" id="perusahaan" class="form-control" data-placeholder="Select" required>
                                        <option value=""></option>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <?php } else { ?>
                                        <select name="customer_id" class="form-control" onchange="get_customer_info(this.value)"  data-placeholder="<?php echo display('select_one'); ?>" required>
                                            <option value=""></option>
                                            <?php
                            ...
                            <div class="col-sm-6">
                                <label for="expiry_date" class="col-sm-4 col-form-label"> Delivery Time<i class="text-danger"></i></label>
                                <div class="col-sm-4">
                        ...
                        <div class="form-group row">                            
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="top" class="form-control" id="top" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">                            
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                 <label for="type" class="col-sm-4 col-form-label">Type Installation<i class="text-danger"></i></label>
                                <div class="col-sm-8">
                                    ...
                                    <table class="table table-bordered table-hover" id="normalinvoice">
                                        ...
                                        <tfoot>
                                            <tr> 
                                                ...
                                                <td class="text-right"> -->
                                                    <input type="hidden" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" id="invoice_discount" class="form-control text-right total_discount" name="invoice_discount" placeholder="0.00"   tabindex="13"/>
                                            ...
                                            <tr>
                                                <td class="text-right" colspan="6"><b><?php echo 'Amount'; ?>:</b></td>
                                                <td class="text-right">
                                                    <input type="text" id="subtotal" class="form-control text-right" name="sub_total" value="0.00" readonly="readonly" />
                                                </td>
                                                <td>
                                                    <a  id="add_invoice_item" class="btn btn-info" name="add-invoice-item"  onClick="addInputField('addinvoiceItem');"  tabindex="11"><i class="fa fa-plus"></i></a>
                                                </td>
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary"  id="service_quotation_div">
                            <?php echo display('add_service_quotation')?>
                        </button>  
                    </div>
                                ...
                                <table class="table table-bordered table-hover" id="serviceInvoice">
                                    ...
                                    <tfoot>
                                        <!-- <tr>
                                            ...
                                            <td class="text-right">-->
                                                <input type="hidden" onkeyup="serviceCAlculation(1);"  onchange="serviceCAlculation(1);" id="service_discount" class="form-control text-right" name="service_discount" placeholder="0.00"  />
                                        ...
                                        <!-- <tr>
                                           ...
                                           <td class="text-right"> -->
                                                <input type="hidden" id="total_service_discount" class="form-control text-right" name="totalServiceDicount" value="0.00" readonly="readonly" />
                                            <!-- </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="4"  class="text-right"><b><?php echo 'Amount'; ?>:</b></td>
                                            <td class="text-right">
                                                <input type="text" id="serviceSubTotal" class="form-control text-right" name="grand_total_service_amount" value="0.00" readonly="readonly" />
                                            </td>
                                            <td>
                                                <button type="button" id="add_service_item" class="btn btn-info" name="add-invoice-item"  onClick="addService('addservicedata');"><i class="fa fa-plus"></i></button>
                                            </td>
                                        ...
                                        <!-- <tr> -->
                                           <!--  <td class="text-right" colspan="4">
                                                <b><?php echo display('total_service_tax') ?>:</b></td>
                                            <td class="text-right"> -->
                                                <?php $x=0;
                                                foreach($taxes as $taxfldt){?>
                                                ...
                                                <?php $x++;}?> 
                                                <input type="hidden" id="total_service_tax" class="form-control text-right" name="total_service_tax" value="0.00" readonly="readonly" />
                                          <!--   </td>         
                                        </tr>   -->              
                                        <!-- <tr>
                                            <td colspan="4"  class="text-right"><b><?php echo display('grand_total') ?>:</b></td>
                                            <td class="text-right">
                                                <input type="text" id="serviceGrandTotal" class="form-control text-right" value="0.00" readonly="readonly" />
