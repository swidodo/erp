                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="mobile" class="form-control" value="<?php echo $quot_main[0]['customer_phone'] ?>" id="mobile" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                 <label for="expiry_date" class="col-sm-4 col-form-label"> Tgl. Kadaluarsa<i class="text-danger"></i></label>
                                 <div class="col-sm-4">
                                    <input type="number" name="quotationexp" id="quotationexp" class="form-control" required value="<?php echo $quot_main[0]['quotation_exp'] ?>">              
                                </div>
                                <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($quot_main[0]['cust_show'] == 1) { ?>
