        ...
        <div class="row">
            <div class="col-sm-12">                
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cquotationproject/update', array('class' => 'form-vertical', 'id' => 'insert_quotation')) 
                    
                    ?>
                    <input type="hidden" id="idquot" name="idquot" value="<?=$qedit[0]['quotation_id']?>">
                    <div class="panel-body">
                        <div class="form-group row">
                                    ...
                                    <?php } else { ?>
                                        <select name="customer_id" class="form-control" onchange="get_customer_info(this.value)"  data-placeholder="<?php echo display('select_one'); ?>">
                                            ...
                                            foreach ($customers as $customer) {
                                                if($qedit[0]['customer_id'] == $customer['customer_id']){
                                                    $sel = 'selected="selected"';
                                                } else {
                                                    $sel = '';
                                                }
                                                ?>
                                                <option value="<?php echo $customer['customer_id'] ?>" <?=$sel?>>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="quotation_no" id="quotation_no" class="form-control" placeholder="<?php echo display('quotation_no') ?>" value="<?php echo $qedit[0]['quot_no']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="address" class="form-control" id="address" readonly value="<?=$qedit[0]['customer_address']?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label for="qdate" class="col-sm-4 col-form-label"><?php echo display('quotation_date') ?> </label>
                                <div class="col-sm-8">
                                    <input type="text" name="qdate" class="form-control datepicker" id="qdate" value="<?php echo $qedit[0]['quotdate'] ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="mobile" class="form-control" id="mobile" readonly value="<?=$qedit[0]['phone']?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                 <label for="expiry_date" class="col-sm-4 col-form-label"><?php echo display('marketing') ?> </label>
                                <div class="col-sm-8">
                                <select name="marketing_id" class="form-control" data-placeholder="<?php echo display('select_one'); ?>" id='marketing_id'>
                                            <option value=""></option>
                                            <?php
                                            foreach ($employees as $employee) {
                                                if($qedit[0]['marketing_id'] == $employee['id']){
                                                    $selmar = 'selected="selected"';
                                                } else {
                                                    $selmar = '';
                                                }
                                                ?>
                                                <option value="<?php echo $employee['id'] ?>" <?=$selmar?>>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="quotationexpsat" class="form-control" data-placeholder="<?php echo display('select_one'); ?>">
                                        <?php
                                        if($quot_main[0]['quotation_exp_sat'] == "hari"){
                                            ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php
                                        if($quot_main[0]['delivery_time_sat'] == "hari"){
                                            ?>
                                            <option value="hari" selected>Hari</option>
                                            <option value="minggu">Minggu</option>
                                            <option value="bulan">Bulan</option> 
                                            <?php
                                        } elseif($quot_main[0]['delivery_time_sat'] == "minggu"){
                                            ?>
                                            <option value="hari">Hari</option>
                                            <option value="minggu" selected>Minggu</option>
                                            <option value="bulan">Bulan</option> 
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="date" class="col-sm-3 col-form-label"><?php echo 'Perusahaan';?> <i class="text-danger">*</i></label>
                                        <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-10">
                                    <textarea  name="details" class="form-control" id="details"><?=$qedit[0]['quot_description'];?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <td><input type='text' name='detailid' class='form-control' placeholder='Product Name' id='detailid'></td>
                                        </div>
                                        <div class="form-group">
...
<script>
    $(document).ready(function(){
        ...
        var idquot = '<?=$qedit[0]['quotation_id'];?>';
