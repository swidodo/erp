...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Data Penawaran Proyek</small>
            <ol class="breadcrumb">
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Kelola Penawaran Proyek</h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive" id="results">
                            <table id="dataQuotProject" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('Cquotation/quotation_details_data/' . $quotation->quotation_id); ?>">
                                        <?php echo html_escape($quotation->quot_no); ?>/<?=$quotation->perusahaan;?>/<?=romawi(intval(date('m')));?>/<?=date('Y');?>
                                    </a>
                                </td>
                                <td>
                                    <?php
                                 ...
                                 <td>
                                    <?php
                                        ...
                                        echo $quotation->marketing;
                                   
                                    ?>
                                </td>
                                <td class="text-right">
                                    <?php 
                                    $itemtotalamount = number_format($quotation->item_total_amount);
                                    echo html_escape((($position == 0) ? "$currency $itemtotalamount" : "$itemtotalamount $currency")); ?>
                                </td>
                                 <!-- <td class="text-right">
                                    <?php 
                                    $totalserviceamount = $quotation->service_total_amount;
                                    echo html_escape((($position == 0) ? "$currency $totalserviceamount" : "$totalserviceamount $currency")); ?>
                                </td> -->
                                <!-- <td><?php
                                ...
                                <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url() . 'Cquotationproject/cetak/' . $quotation->quotation_id; ?>" class="btn btn-info btn-sm"   title="Cetak Penawaran" data-original-title="Cetak Penawaran"><i class="fa fa-print" aria-hidden="true"></i></a>
                                       <?php
                                    if ($quotation->status == 1) {?>
                                         <?php if($this->permission1->method('manage_quotation','update')->access()){ ?>
                                        <a href="<?php echo base_url() . 'Cquotationproject/edit/' . $quotation->quotation_id; ?>" class="btn btn-primary btn-sm" title="<?php echo display('update') ?>" data-original-title="<?php echo display('update') ?> "><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <?php }?>
                                      <?php }?>
                                       
                                        <?php if($this->permission1->method('manage_quotation','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'Cquotation/destroy/' . $quotation->quotation_id; ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are You Sure To Want to Delete ??')" title="<?php echo display('delete') ?>" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
