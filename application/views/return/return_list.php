                        ...
                        <div class="table-responsive">
                            ...
                            <td class="text-right"><?php echo (($position == 0) ? "$currency {net_total_amount}" : "{net_total_amount} $currency") ?></td>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'Cretrun_m/invoice_inserted_data/{invoice_id}'; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-print" aria-hidden="true"></i></a>
