            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label"><?php echo display('invoice_logo') ?> CIKA <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label"><?php echo display('invoice_logo') ?>  KIA <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="invoice_logo2" id="invoice_logo2" type="file" tabindex="2">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label"></label>
                            <div class="col-sm-6">
                                <img src="{invoice_logo_2}" class="img img-responsive" height="100" width="100">
                                <input name ="old_invoice_logo2" type="hidden" value="{invoice_logo_2}">
                            </div>
                        </div>
                        <div class="form-group row">
