           ...
           'lengthMenu':[[10, 25, 50,100,250,500, total_product], [10, 25, 50,100,250,500, "All"]],
             ...
             dom:"'<'col-sm-4'l><'col-sm-4 text-center'><'col-sm-4'>Bfrtip", buttons:[ {
                extend: "copy",exportOptions: {
                       columns: [ 0, 1,2,4,5,6,7,8 ] //Your Colume value those you want
                           }, className: "btn-sm prints"
            }
            , {
                extend: "csv", title: "Product List",exportOptions: {
                       columns: [ 0, 1,2,4,5,6,7,8] //Your Colume value those you want print
                           }, className: "btn-sm prints"
            }
            , {
                extend: "excel",exportOptions: {
                       columns: [ 0, 1,2,4,5,6,7,8 ] //Your Colume value those you want print
                           }, title: "Product List", className: "btn-sm prints"
            }
            , {
            ...
            , {
                extend: "print",exportOptions: {
                       columns: [ 0, 1,2,4,5,6,7,8 ] //Your Colume value those you want print
                           },title: "<image src='http://localhost/supernova/./my-assets/image/logo/prodlogo/6bd41cfbad20b2c8c719be985aa15e14.png' alt='logo'><br />Product List", className: "btn-sm prints"
            }
            ],
...
// console.log('--',lastPart);
    ...
    /*product part*/
    var total_product_history = $("#total_product_history").val();
     var currency = $("#currency").val();
     ...
     $('#productHistory').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, total_product_history], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'Cproduct/CheckProducHistory',
               data:{
                csrf_test_name : CSRF_TOKEN,code:lastPart
               }
            },
          'columns': [
             { data: 'sl' },
             ...
             { data: 'created_at' },
             { data: 'type' },
           { data: 'qty',class:"qty",render: $.fn.dataTable.render.number() },
          ],
  ...
  api.columns('.qty', {
    ...
    $(this.footer()).html(sum.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0}));
  });
...
var invoiceapprovedatatable = $('#InvApproveList').DataTable({ 
  responsive: true,
...
'lengthMenu':[[10, 25, 50,100,250,500, total_invoice], [10, 25, 50,100,250,500, "All"]],
 ...
 'serverMethod': 'post',
 'ajax': {
    'url': base_url + 'Cinvoice/CheckInvoiceApproval',
      "data": function ( data) {
data.fromdate = $('#from_date').val();
data.todate = $('#to_date').val();
data.csrf_test_name = csrf_test_name;
...
$(this.footer()).html(currency+' '+sum.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));
    ...
    var invoicedatatable = $('#DoList').DataTable({ 
             responsive: true,
           ...
           'lengthMenu':[[10, 25, 50,100,250,500], [10, 25, 50,100,250,"All"]],
            ...
            , {
                extend: "csv", title: "DOList",exportOptions: {
                       columns: [ 0, 1, 2, 3,4,5,6] //Your Colume value those you want print
                           }, className: "btn-sm prints"
            }
            , {
                extend: "excel",exportOptions: {
                       columns: [ 0, 1, 2, 3,4,5,6] //Your Colume value those you want print
                           }, title: "DOList", className: "btn-sm prints"
            }
            , {
                extend: "pdf",exportOptions: {
                       columns: [ 0, 1, 2, 3,4,5,6 ] //Your Colume value those you want print
                           }, title: "Delivery Order List", className: "btn-sm prints"
            }
            , {
                extend: "print",exportOptions: {
                       columns: [ 0, 1, 2, 3,4,5,6 ] //Your Colume value those you want print
                           }, title: "<center>Delivery Order List</center>", className: "btn-sm prints"
            }
            ],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'Cinvoice/CheckDoList',
                 "data": function ( data) {
         data.fromdate = $('#from_date').val();
         data.todate = $('#to_date').val();
        data.csrf_test_name = csrf_test_name;
        ...
        /**=================================================== */
        var invoicedatatable = $('#QuotList').DataTable({ 
          responsive: true,
        ...
        'lengthMenu':[[10, 25, 50,100,250,500], [10, 25, 50,100,250,"All"]],
         ...
         , {
             extend: "csv", title: "QuotList",exportOptions: {
                    columns: [ 0, 1, 2, 3,4,5,6] //Your Colume value those you want print
                        }, className: "btn-sm prints"
         }
         , {
             extend: "excel",exportOptions: {
                    columns: [ 0, 1, 2, 3,4,5,6] //Your Colume value those you want print
                        }, title: "QuotList", className: "btn-sm prints"
         }
         , {
             extend: "pdf",exportOptions: {
                    columns: [ 0, 1, 2, 3,4,5,6 ] //Your Colume value those you want print
                        }, title: "Quotation List", className: "btn-sm prints"
         }
         , {
             extend: "print",exportOptions: {
                    columns: [ 0, 1, 2, 3,4,5,6 ] //Your Colume value those you want print
                        }, title: "<center> Quotation List</center>", className: "btn-sm prints"
         }
         ],
         ...
         'serverMethod': 'post',
         'ajax': {
            'url': base_url + 'Cquotation/CheckQuotList',
              "data": function ( data) {
                  data.fromdate = $('#from_date').val();
                  data.todate = $('#to_date').val();
                  data.csrf_test_name = csrf_test_name;
...
$(document).ready(function() { 
   ...
   var base_url = $("#base_url").val();
    $('#checkListStockList').DataTable({ 
          ...
          //  'lengthMenu':[[10, 25, 50,50,50,50,50,50], [10, 25, 50,50,50,50,50,50,50]],
