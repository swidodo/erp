...
var options = {
    ...
    $.ajax( {
      url: base_url + "Cpurchase/product_search",
      method: 'post',
      dataType: "json",
      data: {
        term: request.term,
...
$(document).ready(function() { 
 ...
 var purchasedatatable = $('#BarangkeluarList').DataTable({ 
         responsive: true,

         "aaSorting": [[1, "desc" ],[1,'ASC']],
         "columnDefs": [
       ...
       'lengthMenu':[[10, 50,20,250, 200,50], [10, 50,20,250, 200,50]],
        ...
        , {
            extend: "csv", title: "Barang Keluar LIst",exportOptions: {
        ...
        , {
            extend: "excel",exportOptions: {
                   columns: [0,1,2,3,4] //Your Colume value those you want print
                       }, title: "Barang Keluar LIst", className: "btn-sm prints"
        }
        , {
        ...
        , {
            extend: "print",exportOptions: {
                   columns: [ 0,1,2,3,4] //Your Colume value those you want print
                       },title: "<center> Barang Keluar List</center>", className: "btn-sm prints"
        }
        ],
        ...
        'serverMethod': 'post',
        'ajax': {
           'url':base_url + 'Cpurchase/CheckBarangKeluarList',
             "data": function ( data) {
