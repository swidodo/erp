...
//     }
    ...
    var gt = t +- dis;
    var dueamount = gt +- paidAmount;

    $("#Total").val(t.toFixed(2, 2));
    $("#grandTotal").val(gt.toFixed(2, 2));
    $("#dueAmmount").val(dueamount.toFixed(2, 2));
